let course_schedule = [
    ...
    { date_string: 'October 18, 2022', plan: 'Derivatives Day 1' },
    { date_string: 'October 25, 2022', plan: 'Derivatives Day 2' },
...
let sections = [
    ...
    { heading: 'Assessments', content: ' In periods of 2 weeks each, students will learn fundamental and technical analysis, equity derivatives, and portfolio review. After learning these concepts, individuals or pairs will present a concept to half the class in a discussion-based environment. At the end of the semester, students will pitch a group of stocks based on what they learned. There will also be a paper trading competition run through the semester.', order: 3.2 },
