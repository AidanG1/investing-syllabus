...
let sections = [
    ...
    { heading: 'Assessments', content: ' In periods of 2 weeks each, students will learn fundamental and technical analysis, equity derivatives, and portfolio review. After learning these concepts, individuals or pairs will present a concept to half the class in a discussion-based environment. At the end of the semester, students will pitch a group of stocks based on what they learned. Each week there will be a canvas discussion on where students make a post and comment about a stock market topic of their choice. Throughout the semester, there will be a paper trading game for extra credit.', order: 3.2 },
