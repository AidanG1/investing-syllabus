...
let sections = [
    ...
    { heading: 'Grade Policies', content: 'Topic Presentations: 35%<br>Participation: 30%<br>Final Project: 20%<br>Discussions: 15%<br>Satisfactory/unsatisfactory cutoff: 65%', order: 7 },
