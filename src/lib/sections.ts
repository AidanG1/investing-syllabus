let course_schedule = [
    ...
    { date_string: 'November 1, 2022', plan: 'Non-stock investments (real estate, crypto, commodities, etc.) and introduce final project' },
    { date_string: 'November 8, 2022', plan: 'Portfolio Building Day 1' },
    { date_string: 'November 15, 2022', plan: 'Portfolio Building Day 2' },
    { date_string: 'November 22, 2022', plan: 'Portfolio Building Day 3' },
